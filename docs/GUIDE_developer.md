# GUIDE_developer — Implementation rules for gsheets-orm
...
| API limits | Batch updates must be used to respect Google Sheets API rate limits |
...
| Direct cell editing | Direct cell-by-cell manipulation creates excessive API calls | Use batched payload writes via spreadsheet.batchUpdate |
